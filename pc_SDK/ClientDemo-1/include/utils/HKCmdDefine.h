...
enum _HK_CLIENT_TYPE
{
	...
	HK_CLIENT_FRISTHD = 1101, //迪特客户
	HK_CLIENT_MYP2P = 1102,  // 珠海环梭
	HK_CLIENT_P2PCCTV = 1103,//迪特2
	HK_CLIENT_QEASY = 1104,   //比利时
	HK_CLIENT_IELINK = 1105,   //胡工
	HK_CLIENT_DXXX=1106,//湘西电信
	HK_CLIENT_VIEWCAM=1107,//荷兰henk
	HK_CLIENT_COSY=1108,//wendy 韩国客户
	HK_CLIENT_CGV=1109,//suki 法国客户
	HK_CLIENT_AMS=1110,//爱马时
	HK_CLIENT_KS=1111,//康视
	HK_CLIENT_WEVIEW=1112,// 北斗
	HK_CLIENT_BLUESTORK=1113,// 古伟慧法国客户
	HK_CLIENT_HZD=1114,// 汇众达
	HK_CLIENT_HZD1=1115,// 汇众达1
	HK_CLIENT_VONO=1116,// 远创科技
	HK_CLIENT_BULBCAM=1117,// 易数码
	HK_CLIENT_PPVIEW=1118,// 青青子木
