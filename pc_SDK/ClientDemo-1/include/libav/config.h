...
#define LIBAV_CONFIGURATION "--enable-memalign-hack --enable-shared --disable-static --disable-debug --enable-gpl --enable-nonfree --enable-gpl --enable-libx264 --enable-libxvid --extra-cflags=-I/mnt/x264-snapshot-20111207-2245 --extra-cflags=-I/mnt/xvidcore/src --extra-ldflags=-L/mnt/x264-snapshot-20111207-2245"
